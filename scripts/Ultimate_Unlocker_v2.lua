...
Text("   ~Killa B's Ultimate Unlocker v2 1.58~  ")
...
for i = 0, 0 do
	for j = 0, 63 do
		stats.set_bool_masked(mpx.."GANGOPSPSTAT_BOOL"..i, true, j)
	end
end
end)
...
for i = 0, 1 do
	for j = 0, 63 do
		stats.set_bool_masked(mpx.."BUSINESSBATPSTAT_BOOL"..i, true, j)
	end
end
end)
...
for k = 0, 0 do
for j = 0, 63 do
	stats.set_bool_masked(mpx.."FIXERPSTAT_BOOL"..i, true, j)
	stats.set_bool_masked(mpx.."FIXERTATTOOSTAT_BOOL"..k, true, j)
end
end
end
end)
...
menu.add_action("LSCM Unlocks <--|", function()
for i = 293403, 293430 do
	globals.set_float(i,100000)
end
end)
Text("~(Choose ^^, Shop/Mod from LSCM shops")
Text("   and change sessions)  ")
menu.add_int_range("Reset Rep", 1, 1, 11, function() return 0 end, function(V)
	if V == 1 then
	vt = 5
	elseif V == 2 then
	vt = 415
...
PlayerIndex = stats.get_int("MPPLY_LAST_MP_CHAR")
	...
	stats.set_int(mpx .. "CAR_CLUB_REP", vt)
end)
Text("~[1/5/10/25/50/75/100/125/150/175/200]")
Text("-{Change session to apply}")
Text("------------------------------------------------------------------")
...
menu.add_action("Unlock all LSC Stuff/Paints", function()
	PlayerIndex = stats.get_int("MPPLY_LAST_MP_CHAR")
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
menu.add_action("Unlock Hidden Liveries", function()
	PlayerIndex = stats.get_int("MPPLY_LAST_MP_CHAR")
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
menu.add_action("Unlock Bunker Research", function()
	PlayerIndex = stats.get_int("MPPLY_LAST_MP_CHAR")
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
for m = 0, 5 do
for j = 0, 63 do
	stats.set_bool_masked(mpx.."DLCGUNPSTAT_BOOL"..i, true, j)
	stats.set_bool_masked(mpx.."GUNTATPSTAT_BOOL"..m, true, j)
end
end
end
local bitSize = 8
for q = 0, 12 do
	for j = 0, 64 / bitSize - 1 do
		stats.set_masked_int("GUNRPSTAT_INT"..q, -1, j * bitSize, bitSize)
	end
end
end)
...
menu.add_action("Unlock Tattoos", function()
	PlayerIndex = stats.get_int("MPPLY_LAST_MP_CHAR")
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
for z = 0, 11 do
	for j = 0, 63 do
		stats.set_bool_masked(mpx.."GANGOPSPSTAT_BOOL"..a, true, j)
		stats.set_bool_masked(mpx.."DLCSMUGCHARPSTAT_BOOL"..a, true, j)
		stats.set_bool_masked(mpx.."FIXERTATTOOSTAT_BOOL"..a, true, j)
		stats.set_bool_masked(mpx.."MP_TUPSTAT_BOOL"..a, true, j)
		stats.set_bool_masked(mpx.."MP_NGPSTAT_BOOL"..a, true, j)
		stats.set_bool_masked(mpx.."MP_NGDLCPSTAT_BOOL"..a, true, j)
		stats.set_bool_masked(mpx.."BUSINESSBATPSTAT_BOOL"..b, true, j)
		stats.set_bool_masked(mpx.."SU20TATTOOSTAT_BOOL"..b, true, j)
		stats.set_bool_masked(mpx.."SU20PSTAT_BOOL"..b, true, j)
		stats.set_bool_masked(mpx.."HEIST3TATTOOSTAT_BOOL"..b, true, j)
		stats.set_bool_masked(mpx.."NGPSTAT_BOOL"..b, true, j)
		stats.set_bool_masked(mpx.."FIXERPSTAT_BOOL"..b, true, j)
		stats.set_bool_masked(mpx.."HISLANDPSTAT_BOOL"..c, true, j)
		stats.set_bool_masked(mpx.."DLCGUNPSTAT_BOOL"..c, true, j)
		stats.set_bool_masked(mpx.."MP_PSTAT_BOOL"..c, true, j)
		stats.set_bool_masked(mpx.."PSTAT_BOOL"..d, true, j)
		stats.set_bool_masked(mpx.."NGDLCPSTAT_BOOL"..e, true, j)
		stats.set_bool_masked(mpx.."CASINOHSTPSTAT_BOOL"..f, true, j)
		stats.set_bool_masked(mpx.."GUNTATPSTAT_BOOL"..g, true, j)
		stats.set_bool_masked(mpx.."NGTATPSTAT_BOOL"..g, true, j)
		stats.set_bool_masked(mpx.."CASINOPSTAT_BOOL"..h, true, j)
		stats.set_bool_masked(mpx.."ARENAWARSPSTAT_BOOL"..i, true, j)
		stats.set_bool_masked(mpx.."TUNERPSTAT_BOOL"..i, true, j)
		stats.set_bool_masked(mpx.."TUPSTAT_BOOL"..z, true, j)
	end
	end
	end
	end
...
Text(" ~Make sure to buy everything for them")
Text(" to stick")
Text("------------------------------------------------------------------")
...
Text("------------------------------------------------------------------")
Text("Temporary Unlocks")
Text("Everything below will remain unlocked")
Text("till you change session")
Text("                 _______________       ")
menu.add_int_range("Get All Clothing", 1, 1, 4, function() return 1 end, function(CltH)
	PlayerIndex = stats.get_int("MPPLY_LAST_MP_CHAR")
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
for i = 287635, 287703 do
		globals.set_int(i,1)
	end
end)
menu.add_action("LS Summer Stuff", function()
for i = 291478, 291478 do
        globals.set_int(i,1)
	end
end)
menu.add_action("LS Tuners Stuff", function()
for i = 292962, 292984 do
for j = 292798, 292804 do
		globals.set_int(i, 1)
        globals.set_int(j, 1)
end
end
...
for i = 290109, 290129 do
		globals.set_int(i,1)
	end
end)
Text("----")
menu.add_action("Infinite Stone Hatchet Power", function()
globals.set_int(262145 + 25056, 999999)
globals.set_int(262145 + 25057, 999999)
globals.set_int(262145 + 25058, 0)
end)
menu.add_action("Disable MK2 Cooldown", function()
globals.set_int(262145 + 28056, 0)
end)
menu.add_action("Remove Sub Missile CD/+Range", function()
globals.set_int(262145 + 29821, 0)
globals.set_int(262145 + 29822, 99999)
end)
menu.add_action("Trigger Alien Egg Mission", function()
globals.set_int(2810287 + 5193 + 344, 20)
end)
Text("Choose^^ then start bunker resupply mission")
menu.add_action("Remove Orbital Cannon CD", function()
	PlayerIndex = stats.get_int("MPPLY_LAST_MP_CHAR")
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
